...
<head>
  ...
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading hall of them to reduce the load. -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('admin') ?>"><i class="fa fa-circle-o"></i> Data User</a></li>
            <li class="active"><a href="<?php echo base_url('admin/tambahuser') ?>"><i class="fa fa-circle-o"></i>Tambah User Baru</a></li>
          </ul>
        </li>
      </ul>
    </section>
                ...
                <form role="form" method="post" action="<?php echo base_url('crud/update') ?>">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="exampleInputPassword1" placeholder="Email" name="email" value=<?php echo $u->email;?> />
                    </div>
                    <div class="form-group">
                      <label for="exampleInputPassword1">Kata Sandi</label>
                      
                      <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Kata Sandi" name="password" value=<?php echo base64_decode($u->password);?> />
                    </div>
                    <div class="form-group">
                  ...
                  <div class="box-footer">
                    <button type="submit" class="btn btn-success">Edit Data User</button>
                  </div>
                </form>
             <?php } ?>
