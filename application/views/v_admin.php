...
<head>
  ...
  <title>Dashboard Botisana</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url('admin') ?>"><i class="fa fa-circle-o"></i> Data User</a></li>
            <li><a href="<?php echo base_url('admin/tambahuser') ?>"><i class="fa fa-circle-o"></i>Tambah User Baru</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
                      <a href="<?php echo base_url("admin/tambahuser") ?>"><button type="button" class="btn-lg btn-block btn-primary">Tambah User Baru</button></a>
                      <br>
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data User Botisana Website  </h3>
